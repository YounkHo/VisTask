    ...
    chart: function() {
        ...
        function radar(selection) {
            selection.each(function(data) {
                ...
                var levelGroups = container.selectAll('g.level-group')
                    .data(levelFactors);
                    ...
                    if (cfg.axisLine) {
                        axis.select('line')
                            ...
                            .style('stroke', function(d, i) {
                                ...
                                if (name === '味道') return "#FFC107";
                                if (name === '环境') return '#28A745';
                                if (name === '服务') return "#DB3444";
                                if (name === '消费') return "#017BFF";
                            });
                        //            .style('stroke','red');
